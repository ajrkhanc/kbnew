                ...
                <div className="what-did-left-content">
                    <div className="row how-we-work-with-u0pa">
                        <div className="col-sm-6">
                            ...
                            <img src="/assets/img/on-sitetraining.png"/>
                        ...
                        <div className="col-sm-6">
                            <div className="equialwithborder">
                            <img src="/assets/img/e-learning.png"/>
                            <h3>E-LEARNING</h3>
                        ...
                        <div className="col-sm-6">
                            <div className="equialwithborder">
                            <img src="/assets/img/virtual-training.png"/>
                        ...
                        <div className="col-sm-6">
                            <div className="equialwithborder">
                            <img src="/assets/img/coaching.png"/>
                            <h3>COACHING</h3>
                        ...
                        <div className="col-sm-6">
                            <div className="equialwithborder">
                            <img src="/assets/img/public-workshops.png"/>
                        ...
                        <div className="col-sm-6">
                            <div className="equialwithborder">
                            <img src="/assets/img/training-for-trainers.png"/>

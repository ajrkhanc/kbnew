...
export default function Elearning() {
    return (
        <>
            <Head>
            <title>Elearning - Blanchard International</title>
                        ...
                        <div className="col-lg-12">
                            <div className="what-did-left-content">
                                <div className="row row-eq-height eventsandworkshopbox">
                                    ...
                                    <div className="col-sm-4">
                                        <div className="choose-card">
                                            <img src="/assets/img/creating-virtual-learning-experiences-with-cindy-huggett.jpg" alt="Images" />
                                            <h3>Creating Virtual learning experiences with cindy huggett</h3>
                                            <div className='row text-center eventsbottomarea2'>
                                                <div className='col-sm-12'>
                                    ...
                                    <div className="col-sm-4">
                                        <div className="choose-card">
                                            <img src="/assets/img/diversity-equity-inclusion-pov2.jpg" alt="Images" />
                                    ...
                                    <div className="col-sm-4">
                                        <div className="choose-card">
                                            <img src="/assets/img/exploring-diversity-beyond-lip-service-with-lawana-harris.jpg" alt="Images" />
                                    ...
                                    <div className="col-sm-4">
                                        <div className="choose-card">
                                            <img src="/assets/img/finding-your-dream-job-with-alexa-shoen.jpg" alt="Images" />
                                    ...
                                    <div className="col-sm-4">
                                        <div className="choose-card">
                                            <img src="/assets/img/leading-with-gratitude-with-adrian-gostick.jpg" alt="Images" />
                                    ...
                                    <div className="col-sm-4">
                                        <div className="choose-card">
                                            <img src="/assets/img/learn-how-to-master-your-motivation-with-susan-fowler.jpg" alt="Images" />

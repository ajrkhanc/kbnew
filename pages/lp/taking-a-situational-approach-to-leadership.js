...
export default function HybridWorkplaces() {
   const Submitdata = async event => {
      ...
      xhttp.open("Post", 'https://bmelectrician.com/blanchard/wp-json/contact-form-7/v1/contact-forms/30279/feedback');
                ...
                <div className='row'>
                   <div className='col-sm-6'>
                        <div className="inner-title text-left">
                            <h3>Taking a Situational Approach to Leadership</h3>                            
                        </div>
                   </div>
                   <div className='col-sm-6'>
                        ...
                        <div className="col-lg-6">
                           <div className="form-group">
                              ...
                              <select className="form-control" name="interest_in" required>
                                 <option value="Taking a Situational Approach to Leadership: 08th April, 2022">Taking a Situational Approach to Leadership: 08th April, 2022</option>
                              </select>
                              <div className="help-block with-errors"></div>
                           </div>
                        </div>
        ...
        <div className="what-did-area pt-20 pb-40">
         <div className="container">
            <div className="row row-eq-height">            
               ...
               <div className="col-lg-6 bgshd">
                  <div className="what-did-content what-did-content-rs">
                     <div className="section-title-two pt-20"> 
                        ...
                        Employees want to become high performers in their organization and for that, they need high-performing leaders with different skills. Successful leaders have the ability to look at situations from different perspectives. Leaders shouldn’t use a single style of leadership and expect the best results.
                        </p>
                        <p className="text-justify">
               ...
               <div className="col-lg-6">
                  <div className="">
                     <img src="/assets/img/sit.jpg" alt="Images"/>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div className="row row-eq-height">
               <div className="col-lg-6 bgshd">
                 <div className='pt-20 pb-25'> 
                  <ol className="">
                    <li>Providing too much direction on tasks where a person is already competent feels like micromanagement.</li>
                    <li>Providing too little direction when questions or problems come up feels like abandonment or being set up to fail.</li>
                  </ol>
                  <p className="text-justify">This creates a culture where people are clear and aligned on objectives so that they can achieve organizational goals faster.</p>
                 </div>
               </div>
               <div className="col-lg-6 bgleftcol16">
                  <div className="text-left pt-20 pb-25">
                  <h2 className="titleh2 text-left">BENEFITS OF THE PROGRAM:</h2> 
                  <p>
                  <ol className="colorwhitlist">
                    <li>Accelerated development</li>
                    <li>Increased retention and morale</li>
                    <li>Increase performance productivity of the employees</li>
                    <li>A common leadership language</li>
                    <li>Proactive problem solvers</li>
                    <li>It is a more flexible approach to leadership</li>
                    <li>It encourages successful collaboration among team members</li>
                  </ol>
                  </p>
                  </div>
               </div>

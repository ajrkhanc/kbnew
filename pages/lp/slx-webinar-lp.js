...
export default function SLXWebinar() {
   const BME = async event => {
      ...
      xhttp.open("Post", 'https://bmelectrician.com/blanchard/wp-json/contact-form-7/v1/contact-forms/30465/feedback');
    ...
    return (
        <>
        <Head>
            <title>Prepare Your Leaders to Lead Situationally: Breakthrough for a Hybrid Workplace</title>
      ...
      <div className='row'>
         <div className='col-sm-6'>
            <div className="inner-title text-left">
               <h3>Prepare Your Leaders to Lead Situationally: Breakthrough for a Hybrid Workplace</h3>
            </div>
         </div>
         <div className='col-sm-6'>
                     ...
                     <div className="col-lg-6">
                        <div className="form-group">
                           ...
                           <select name="interest_in" className="form-control" required>
                              ...
                              <option value="Prepare Your Leaders to Lead Situationally: Breakthrough for a Hybrid Workplace 8th July 2022">Prepare Your Leaders to Lead Situationally: Breakthrough for a Hybrid Workplace 8th July 2022</option>
                           </select>
                           <div className="help-block with-errors"></div>
                        </div>
                     </div>
   ...
   <div className="container">
      <div className="row row-eq-height">
         ...
         <div className="col-lg-6 themebg2">
            <div className="">
               <img src="/assets/img/slx-lp-webinarmain.jpg" alt="Images" />
            </div>
         </div>
      </div>
   </div>

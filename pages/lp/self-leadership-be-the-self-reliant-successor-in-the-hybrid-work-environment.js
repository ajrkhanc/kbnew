...
export default function HybridWorkplaces() {
   const Submitdata = async event => {
      ...
      xhttp.open("Post", 'https://bmelectrician.com/blanchard/wp-json/contact-form-7/v1/contact-forms/30238/feedback');
   ...
   <div className="container">
      <div className="row row-eq-height">
         ...
         <div className="col-lg-6 themebg2">
            <div className="">
               <img src="/assets/img/self.jpg" alt="Images" />
            </div>
         </div>
      </div>
   </div>
      ...
      <div className="row row-eq-height">
         ...
         <div className="col-lg-6 bgshd">
            <div className='pt-15 pb-15'>
              <img src="/assets/img/business-1.jpg" alt="Images" />
            </div>
         </div>
      </div>
   </div>

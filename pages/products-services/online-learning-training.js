...
export default function OnlineLearning() {
   ...
   <div className="container">
      <div className="row row-eq-height">
         ...
         <div className="col-lg-6">
            <div className="">
            <img className='online-learningimg100' src="/assets/img/online-learning2.jpg" alt="Images"/>
            </div>
         </div>
      </div>
   </div>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <div className="case-studies-list">
                                                <i className='hoverbgn'><img src='/assets/img/ol-online-leadership-training-savings.png'/></i>
                                                <p>                                                
                                        ...
                                        <div className="col-lg-12">
                                            <div className="case-studies-list">
                                                <i className='hoverbgn'><img src='/assets/img/ol-leadership-training-programs-productivity-boost.png'/></i>
                        ...
                        <div className="what-did-left-content">
                            <div className="row row-eq-height online-learing-eq3">
                                ...
                                <div className="what-did-left-card what-did-left-card-sl2 text-center">
                                    <img src="/assets/img/maximize-reach.png"/>
                                ...
                                <div className="col-sm-3">
                                <div className="what-did-left-card what-did-left-card-sl2 text-center">
                                    <img src="/assets/img/save-time.png"/>
                                ...
                                <div className="col-sm-3">
                                <div className="what-did-left-card what-did-left-card-sl2 text-center">
                                    <img src="/assets/img/take-advantage.png"/>
                                ...
                                <div className="col-sm-3">
                                <div className="what-did-left-card what-did-left-card-sl2 text-center">
                                    <img src="/assets/img/move-at.png"/>
         ...
         <div className="container">
            <div className="row row-eq-height">            
               ...
               <div className="col-lg-6 themebg2">
                  <div className="">
                     <img src="/assets/img/online-leadership-training-model.jpg" alt="Images"/>                      
                  </div>
               </div>
            </div>
         </div>

         ...
         <div className="col-lg-6 bgshd">
            <div className="what-did-content">
               <div className="section-title pt-20">                 
                  <h2 className="titleh2">A Jump Start For Virtual Facilitation</h2>
                  <p className="text-justify">
                      We all know the virtual environment is different from the traditional classroom and the same rules may not apply equally. Our training designs for virtual sessions have been developed to maximize participation and learning, and rely on a variety of virtual platform functionalities.
                  </p>
               </div>
            </div>
         </div>

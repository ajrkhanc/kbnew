...
function EbooksKB() {
   ...
   return (
      <>
         <Head>
            <title>7 Ways Poor Leaders Are Costing Your Company Money</title>
         ...
         <div className="col-lg-6 bgshd">
            <div className="what-did-content">
               <div className="section-title pt-20">                 
                  <h2 className="titleh2">7 WAYS POOR LEADERS ARE COSTING YOUR COMPANY MONEY</h2>
                  <b>Poor managerial behaviors negatively impact engagement, alignment, productivity, and retention.</b>
                  <p className="text-justify">
                      Research conducted by The Ken Blanchard Companies<sup>®</sup>, together with Training magazine, identified some important gaps between what people expect and what they experience when having work conversations with their immediate manager. 
                  </p>
               </div>
            </div>
         </div>

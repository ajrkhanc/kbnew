...
function EbooksKB() {
   ...
   return (
      <>
         <Head>
            <title>Learn How to Master Your Motivation with Susan Fowler</title>
        ...
        <div className="container">
            <div className="row">
                ...
                <div className='text-center pb-25'>
                    ...
                    <h3 className='titleh2'>Learn How to Master Your Motivation with Susan Fowler</h3>
                    <p>Hear motivation expert Susan Fowler describe the three basic needs that are essential to optimal motivation: choice, connection, and competence. She explains we all need to create these three needs in our lives in order to thrive.</p>

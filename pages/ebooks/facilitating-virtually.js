...
function EbooksKB() {
         ...
         if (xhttp.readyState == 4) {
            ...
            if (res.status == "mail_sent") {
               ...
               window.setTimeout(function () {
                   window.location.href = "/pdf/a-jump-start-for-virtual-facilitation.pdf"
               }, 3000);
   ...
   return (
      <>
         <Head>
            <title>Facilitating Virtually</title>
        ...
        <div className="container">
            <div className="row">
                ...
                <div className='text-center pb-25'>
                    ...
                    <h3 className='titleh2'>Facilitating Virtually</h3>
                    <p>Moving from a face-to-face environment into a virtual one can raise doubts among even the most experienced training professionals. How do I convert my favorite classroom activities? How do I keep learners engaged? The principles that underlie teaching in a virtual classroom are much the same as training in person. Your goal is to connect people, at a deep level, to information and strategies that can change their world. This eBook will help you start developing your new virtual skills today!</p>

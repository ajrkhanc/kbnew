...
function EbooksKB() {
   ...
   return (
      <>
         <Head>
            <title>7 Warning Signs That Distrust Is Harming Your Organization</title>
  ...
  <section>
      <div className="img100">
          <img src="/assets/img/7warningb.jpg"  alt="diversity-equity-inclusion-pov"/>
      </div>
  </section>          
   ...
   <div className="container">
      <div className="row row-eq-height">
         <div className="col-lg-6 bgshd">
            <div className="what-did-content">
               <div className="section-title pt-20">                 
                  <h2 className="titleh2">7 Warning Signs That Distrust Is Harming Your Organization</h2>
                  <b>Trust is at the heart of every relationship, and that includes the workplace</b>
                  <p className="text-justify">
                      Building trust from the very beginning is essential for success. However, when employees lack trusting relationships with one another and with their managers, it’s a recipe for a toxic work environment.
                  </p>
               </div>
            </div>
         </div>
         <div className="col-lg-6">
            <div className="img100">
            <img src="/assets/img/7warning.jpg" alt="Images"/>
            </div>
         </div>
      </div>
   </div>
